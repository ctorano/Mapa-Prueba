...
map.getView().fit([-611050.175680, 5347934.576414, -580971.795297, 5377721.421807], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Turismo en Piloña</h2>';
        return titleElement;
    })(),
